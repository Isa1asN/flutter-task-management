...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  _update() async {
    List<TaskModel> list = await SqliteHelper.instance
        .getHistoryTaskList(_selectedDay.toIso8601String());
  ...
  Future<Map<DateTime, List<Events>>> _createMap(List<String> list) async {
    ...
    for (int x = 0; x < list.length; x++) {
      ...
      List<Map<String, dynamic>> fetchedList =
          await SqliteHelper.instance.getTasksOnlyList(list[x]);
          ...
          TableCalendar<Events>(
            ...
            onDaySelected: (selectedDay, focusedDay) {
              if (!isSameDay(_selectedDay, selectedDay)) {
                ...
                print(
                    'The list for day ${_selectedDay} is ${_getEventsForDay(selectedDay).toString()}');
              }
            },
          ...
          Expanded(
            child: ValueListenableBuilder(
              ...
              builder: (context, value, _) {
                // logging
                print(
                    "Listview about to run with data: ${_selectedEvents.value.length}");
