...
class _HomePageState extends State<HomePage> {
  Color color = Color.fromARGB(255, 8, 115, 123);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      backgroundColor: Color.fromARGB(255, 6, 107, 90),
          ...
          child: ListView(
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text("Home",
                    style: TextStyle(letterSpacing: 2.0, fontSize: 20.0)),
              ),
              ExpansionTile(
                          ...
                          return ListTile(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          CategoryScreen(cat: items[index])));
                            },
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      AddTask(updateTaskList: _updateTaskList)),
            );
          },
        ),
      ),
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              color: Color.fromARGB(255, 6, 107, 90),
            ),
            child: Padding(
          ...
          task.isreminder == 1
              ? Row(
                  children: <Widget>[
                    ...
                    Text(
                      ' ${task.reminder.hour.toString().padLeft(2, '0')}:${task.reminder.minute.toString().padLeft(2, '0')}',
                      style: TextStyle(
                          fontSize: 12.0,
                          letterSpacing: 1.0,
                          decoration: task.iscomplete == 1
