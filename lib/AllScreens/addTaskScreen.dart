...
class _AddTaskState extends State<AddTask> {
  ...
  Future<Null> _showTimePicker(BuildContext context) async {
    ...
    var secs = _reminder.difference(rightNow).inSeconds;
  ...
  String _stringBuilder(DateTime reminder) {
    ...
    if (x >= 1) {
      ...
      int z = hours % 24;
      result =
          'Reminder set $y days ${z.toString()} hours ${dif[1]} minutes ${dif[2].substring(0, 1)} seconds';
    } else {
      if (hours <= 0) {
        result =
        ...
        result =
            'Reminder set in ${hours.toString()} hours ${dif[1]} minutes ${dif[2].substring(0, 1)} seconds';
      }
    }
