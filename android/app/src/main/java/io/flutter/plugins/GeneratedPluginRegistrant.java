...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new de.ju.application_icon.ApplicationIconPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin application_icon, de.ju.application_icon.ApplicationIconPlugin", e);
    }
    try {
